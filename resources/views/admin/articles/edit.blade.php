...
@section('page-title')
    ...
    <span class="text-black">Edit Artikel</span>
@endsection


@section('content')

<form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data" class="bg-white text-gray-800 p-6 rounded-lg shadow space-y-5">
    @csrf
    @method('PUT')
